...
/**
 * @file stats.c
 * @brief code to analyze an array of unsigned char data items and report analytics on the maximum, minimum, mean, and median of the data set
 *
 * Various functions are implemented on an array
 *
 * @author Parishi Naik
